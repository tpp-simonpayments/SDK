...
class ApiApi(object):
    ...
    def authorize_with_http_info(self, amount, cc, mm, yy, cvv, **kwargs):  # noqa: E501
        ...
        all_params = ['amount', 'cc', 'mm', 'yy', 'cvv', 'ticket', 'meta']  # noqa: E501
    ...
    def charge(self, amount, transaction_id, cc, mm, yy, cvv, **kwargs):  # noqa: E501
        """Charge a credit card or settle a previous charge.  # noqa: E501

        Charge a credit card or settle a previous charge.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.charge(amount, transaction_id, cc, mm, yy, cvv, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str amount: The total transaction amount. This is the amount of funds to move on the card (required)
        :param str transaction_id: Transaction ID used to settle an authorized card (cc info then not required) (required)
        :param str cc: Credit Card Number with or without dashes (required)
        :param str mm: 2 digit month (required)
        :param str yy: 2 digit year (required)
        :param str cvv: Card Verification Value found on the card (CVV2, CVC2, CID) (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.charge_with_http_info(amount, transaction_id, cc, mm, yy, cvv, **kwargs)  # noqa: E501
        else:
            (data) = self.charge_with_http_info(amount, transaction_id, cc, mm, yy, cvv, **kwargs)  # noqa: E501
            return data

    def charge_with_http_info(self, amount, transaction_id, cc, mm, yy, cvv, **kwargs):  # noqa: E501
        """Charge a credit card or settle a previous charge.  # noqa: E501

        Charge a credit card or settle a previous charge.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.charge_with_http_info(amount, transaction_id, cc, mm, yy, cvv, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['amount', 'transaction_id', 'cc', 'mm', 'yy', 'cvv', 'ticket', 'meta']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('transaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `transaction_id` when calling `charge`")  # noqa: E501
        # verify the required parameter 'cc' is set
        if ('cc' not in params or
                params['cc'] is None):
    ...
    def enroll(self, dba_name, email, website, fed_tx_id, legal_name, start_date, account_holder_name, account_type, account_number, routing_number, ownership_type, business_description, business_phone_number, business_address_1, business_address_2, business_city, business_state_province, business_postal_code, principle_first_name, principle_last_name, principle_ssn, principle_date_of_birth, principle_address_line_1, principle_address_line_2, principle_city, principle_state_province, principle_postal_code, principle_title, principle_ownership_percentage, principle_phone_number, **kwargs):  # noqa: E501
        ...
        :param list[str] ownership_type: Select an ownership type: (required)
    ...
    def enroll_with_http_info(self, dba_name, email, website, fed_tx_id, legal_name, start_date, account_holder_name, account_type, account_number, routing_number, ownership_type, business_description, business_phone_number, business_address_1, business_address_2, business_city, business_state_province, business_postal_code, principle_first_name, principle_last_name, principle_ssn, principle_date_of_birth, principle_address_line_1, principle_address_line_2, principle_city, principle_state_province, principle_postal_code, principle_title, principle_ownership_percentage, principle_phone_number, **kwargs):  # noqa: E501
        ...
        if 'ownership_type' in params:
            ...
            collection_formats['ownership_type'] = 'multi'  # noqa: E501
    ...
    def settle(self, transaction_id, **kwargs):  # noqa: E501
        """Alternative to sending a transactionId to charge, this method will settle an outstanding Authorization.  # noqa: E501

        Alternative to sending a transactionId to charge, this method will settle an outstanding Authorization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.settle(transaction_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str transaction_id: Transaction ID of charged event. (required)
        :param str ticket: Ticket Number used by POS
        :param object meta: Optional user defined object to be returned with future response
        :return: list[Response]
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.settle_with_http_info(transaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.settle_with_http_info(transaction_id, **kwargs)  # noqa: E501
            return data

    def settle_with_http_info(self, transaction_id, **kwargs):  # noqa: E501
        """Alternative to sending a transactionId to charge, this method will settle an outstanding Authorization.  # noqa: E501

        Alternative to sending a transactionId to charge, this method will settle an outstanding Authorization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.settle_with_http_info(transaction_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['transaction_id', 'ticket', 'meta']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('transaction_id' not in params or
                params['transaction_id'] is None):
            raise ValueError("Missing the required parameter `transaction_id` when calling `settle`")  # noqa: E501
    ...
    def void(self, transaction_id, **kwargs):  # noqa: E501
        """A Void transaction can be used to back out a previous Sale transaction.  # noqa: E501

        A Void transaction can be used to back out a previous Sale transaction.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.void(transaction_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.void_with_http_info(transaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.void_with_http_info(transaction_id, **kwargs)  # noqa: E501
            return data

    def void_with_http_info(self, transaction_id, **kwargs):  # noqa: E501
        """A Void transaction can be used to back out a previous Sale transaction.  # noqa: E501

        A Void transaction can be used to back out a previous Sale transaction.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.void_with_http_info(transaction_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('transaction_id' not in params or
                params['transaction_id'] is None):
            raise ValueError("Missing the required parameter `transaction_id` when calling `void`")  # noqa: E501
