...
namespace IO.Swagger.Test
{
    ...
    public class ApiApiTests
    {
        ...
        public void ActivateTest()
        {
            ...
            //Object meta = null;
            //var response = instance.Activate(activationCode, terminalId, meta);
        ...
        public void AuthorizeTest()
        {
            ...
            //string ticket = null;
            //Object meta = null;
            //var response = instance.Authorize(amount, cc, mm, yy, cvv, zipcode, ticket, meta);
            //Assert.IsInstanceOf<List<Response>> (response, "response is List<Response>");
        }
        /// <summary>
        /// Test CallVoid
        ...
        public void CallVoidTest()
        {
            ...
            //string ticket = null;
            //Object meta = null;
            //var response = instance.CallVoid(id, ticket, meta);
            //Assert.IsInstanceOf<List<Response>> (response, "response is List<Response>");
        }
        /// <summary>
        /// Test Charge
        ...
        public void ChargeTest()
        {
            ...
            //string ticket = null;
            //Object meta = null;
            //var response = instance.Charge(amount, cc, mm, yy, cvv, accountNumber, routingNumber, type, id, zipcode, ticket, meta);
            //Assert.IsInstanceOf<List<Response>> (response, "response is List<Response>");
        }
        /// <summary>
        /// Test Credit
        ...
        public void CreditTest()
        {
            ...
            //string ticket = null;
            //Object meta = null;
            //var response = instance.Credit(amount, cc, mm, yy, cvv, zipcode, ticket, meta);
            //Assert.IsInstanceOf<List<Response>> (response, "response is List<Response>");
        }
        /// <summary>
        /// Test Enroll
        ...
        public void ReportTest()
        {
            ...
            //string end = null;
            //string dates = null;
            //var response = instance.Report(start, end, dates);
            //Assert.IsInstanceOf<List<Response>> (response, "response is List<Response>");
        }
        /// <summary>
        /// Test Settle
        ...
        public void SettleTest()
        {
            ...
            //string ticket = null;
            //Object meta = null;
            //var response = instance.Settle(id, ticket, meta);
            //Assert.IsInstanceOf<List<Response>> (response, "response is List<Response>");
        }
        /// <summary>
        /// Test Tokenize
