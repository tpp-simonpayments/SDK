...
class ApiApi
{
     ...
     *
     * @param  string $activation_code Activation Code on Terminal Screen (required)
     * @param  string $terminal_id Custom Name of Terminal (required)
     ...
     */
    public function activate($activation_code, $terminal_id, $meta = null)
    {
        list($response) = $this->activateWithHttpInfo($activation_code, $terminal_id, $meta);
        return $response;
    }
     ...
     */
    public function activateWithHttpInfo($activation_code, $terminal_id, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->activateRequest($activation_code, $terminal_id, $meta);
     ...
     */
    public function activateAsync($activation_code, $terminal_id, $meta = null)
    {
        return $this->activateAsyncWithHttpInfo($activation_code, $terminal_id, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function activateAsyncWithHttpInfo($activation_code, $terminal_id, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->activateRequest($activation_code, $terminal_id, $meta);
     ...
     */
    protected function activateRequest($activation_code, $terminal_id, $meta = null)
    {
        // verify the required parameter 'activation_code' is set
        if ($activation_code === null || (is_array($activation_code) && count($activation_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $activation_code when calling activate'
            );
        }
        // verify the required parameter 'terminal_id' is set
        if ($terminal_id === null || (is_array($terminal_id) && count($terminal_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $terminal_id when calling activate'
            );
        }
        ...
        if ($activation_code !== null) {
            $queryParams['activationCode'] = ObjectSerializer::toQueryValue($activation_code, null);
        }
        // query params
        if ($terminal_id !== null) {
            $queryParams['terminalId'] = ObjectSerializer::toQueryValue($terminal_id, null);
        }
        // query params
        if ($meta !== null) {
     ...
     * @param  string $zipcode Zip code. *optional synonym: zip (optional)
     ...
     * @return \Swagger\Client\Model\Response[]
     */
    public function authorize($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        list($response) = $this->authorizeWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $zipcode, $ticket, $meta);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Response[], HTTP status code, HTTP response headers (array of strings)
     */
    public function authorizeWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->authorizeRequest($amount, $cc, $mm, $yy, $cvv, $zipcode, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authorizeAsync($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        return $this->authorizeAsyncWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $zipcode, $ticket, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authorizeAsyncWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->authorizeRequest($amount, $cc, $mm, $yy, $cvv, $zipcode, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function authorizeRequest($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        ...
        // query params
        if ($zipcode !== null) {
            $queryParams['zipcode'] = ObjectSerializer::toQueryValue($zipcode, null);
        }
        // query params
        if ($ticket !== null) {
     ...
     * @param  string $routing_number Bank Routing Number (required)
     * @param  string $type Options: checking, savings *default checking (required)
     * @param  string $id Transaction ID used to settle an authorized payment method (cc or bank info then not required) *optional synonym: transactionId (optional)
     * @param  string $zipcode Zip code. *optional synonym: zip (optional)
     * @param  string $ticket Ticket Number used by POS (optional)
     * @param  object $meta Optional user defined object to be returned with future response (optional)
     *
     ...
     * @return \Swagger\Client\Model\Response[]
     */
    public function charge($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id = null, $zipcode = null, $ticket = null, $meta = null)
    {
        list($response) = $this->chargeWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id, $zipcode, $ticket, $meta);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Response[], HTTP status code, HTTP response headers (array of strings)
     */
    public function chargeWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id = null, $zipcode = null, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->chargeRequest($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id, $zipcode, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chargeAsync($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id = null, $zipcode = null, $ticket = null, $meta = null)
    {
        return $this->chargeAsyncWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id, $zipcode, $ticket, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chargeAsyncWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id = null, $zipcode = null, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->chargeRequest($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id, $zipcode, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function chargeRequest($amount, $cc, $mm, $yy, $cvv, $account_number, $routing_number, $type, $id = null, $zipcode = null, $ticket = null, $meta = null)
    {
        // verify the required parameter 'amount' is set
        if ($amount === null || (is_array($amount) && count($amount) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($account_number === null || (is_array($account_number) && count($account_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_number when calling charge'
            );
        }
        // verify the required parameter 'routing_number' is set
        if ($routing_number === null || (is_array($routing_number) && count($routing_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $routing_number when calling charge'
            );
        }
        // verify the required parameter 'type' is set
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling charge'
            );
        }
        ...
        if ($routing_number !== null) {
            $queryParams['routingNumber'] = ObjectSerializer::toQueryValue($routing_number, null);
        }
        // query params
        if ($type !== null) {
     ...
     * @return \Swagger\Client\Model\Response[]
     */
    public function credit($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        list($response) = $this->creditWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $zipcode, $ticket, $meta);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Response[], HTTP status code, HTTP response headers (array of strings)
     */
    public function creditWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->creditRequest($amount, $cc, $mm, $yy, $cvv, $zipcode, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function creditAsync($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        return $this->creditAsyncWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $zipcode, $ticket, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function creditAsyncWithHttpInfo($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->creditRequest($amount, $cc, $mm, $yy, $cvv, $zipcode, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function creditRequest($amount, $cc, $mm, $yy, $cvv, $zipcode = null, $ticket = null, $meta = null)
    {
        // verify the required parameter 'amount' is set
        if ($amount === null || (is_array($amount) && count($amount) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $ownership_type [\&quot;Sole Proprietor\&quot;, \&quot;C-Corp Private\&quot;, \&quot;C-Corp Public\&quot;, \&quot;S-Corp Private\&quot;, \&quot;S-Corp Public\&quot;, \&quot;LLC Private\&quot;, \&quot;LLC Public\&quot;, \&quot;Not For Profit\&quot;, \&quot;Partnership Private\&quot;, \&quot;Partnership\&quot;, \&quot;Government Agency\&quot;] (required)
     ...
     *
     * @param  string $start Start of date range YYYY-MM-DD **defaults to that day (optional)
     * @param  string $end End of date range YYYY-MM-DD (optional)
     * @param  string $dates Optional list of range, example: [\&quot;YYYY-MM-DD\&quot;,\&quot;YYYY-MM-DD\&quot;] (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Response[]
     */
    public function report($start = null, $end = null, $dates = null)
    {
        list($response) = $this->reportWithHttpInfo($start, $end, $dates);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Response[], HTTP status code, HTTP response headers (array of strings)
     */
    public function reportWithHttpInfo($start = null, $end = null, $dates = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->reportRequest($start, $end, $dates);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportAsync($start = null, $end = null, $dates = null)
    {
        return $this->reportAsyncWithHttpInfo($start, $end, $dates)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportAsyncWithHttpInfo($start = null, $end = null, $dates = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->reportRequest($start, $end, $dates);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function reportRequest($start = null, $end = null, $dates = null)
    {
        ...
        // query params
        if ($dates !== null) {
            $queryParams['dates'] = ObjectSerializer::toQueryValue($dates, null);
        }
     ...
     *
     * @param  string $id Transaction ID of charged event. *optional synonym: transactionId (required)
     * @param  string $ticket Ticket Number used by POS (optional)
     * @param  object $meta Optional user defined object to be returned with future response (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return \Swagger\Client\Model\Response[]
     */
    public function settle($id, $ticket = null, $meta = null)
    {
        list($response) = $this->settleWithHttpInfo($id, $ticket, $meta);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Response[], HTTP status code, HTTP response headers (array of strings)
     */
    public function settleWithHttpInfo($id, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->settleRequest($id, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function settleAsync($id, $ticket = null, $meta = null)
    {
        return $this->settleAsyncWithHttpInfo($id, $ticket, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function settleAsyncWithHttpInfo($id, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->settleRequest($id, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function settleRequest($id, $ticket = null, $meta = null)
    {
     ...
     * @return \Swagger\Client\Model\Response[]
     */
    public function void($id, $ticket = null, $meta = null)
    {
        list($response) = $this->voidWithHttpInfo($id, $ticket, $meta);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Response[], HTTP status code, HTTP response headers (array of strings)
     */
    public function voidWithHttpInfo($id, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->voidRequest($id, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voidAsync($id, $ticket = null, $meta = null)
    {
        return $this->voidAsyncWithHttpInfo($id, $ticket, $meta)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voidAsyncWithHttpInfo($id, $ticket = null, $meta = null)
    {
        $returnType = '\Swagger\Client\Model\Response[]';
        $request = $this->voidRequest($id, $ticket, $meta);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function voidRequest($id, $ticket = null, $meta = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
